	...
	<div class="main_part_outer" id="content">
		<div class="d-flex flex-column w-100 h-100">
			...
			<!--main_tittle-->
			    <div class="row">
			       <div class="col-md-9">
			           <div class="main_tittle">Planner's Dashboard <span id="Date">Wednesday , 21 November 2018</span></div>
	...
	<!-- <h5 class="boxHeading bg-blue">Articles</h5> -->
      ...
      <div class="col col-md-4 mb-3"> 
        ...
        <div class="small-box bg-dark-green-gradient d-flex align-items-center h-100 text-white" >
          	<h3>Total Running Articles &nbsp;:&nbsp; ${totalarticleavailable.size()}
      ...
      <div class="col col-md-4 mb-3"> 
        ...
        <div class="small-box bg-green-gradient d-flex align-items-center h-100 text-white" >
        	<h3>Overdue Articles(Past 24 Hours) &nbsp;:&nbsp; ${totalarticleavailablepast24.size()}
     ...
     <%--  <div class="col mb-3"> 
      ...
      <div class="col col-md-4 mb-3"> 
        ...
        <div class="small-box bg-red-gradient d-flex align-items-center h-100 text-white" >
        	<h3>Overdue Articles(Past 48 Hours) &nbsp;:&nbsp; ${totalarticleavailablepast48.size()}
	...
	<path d="M362.3,352.5c-2.1,4.4-7.3,6.4-11.8,4.3c-4.4-2.1-6.4-7.3-4.3-11.8c0,0,0,0,0,0c2.1-4.4,7.3-6.4,11.8-4.3
       ...
       <div class="col col-md-4 mb-3"> 
        ...
        <div class="small-box bg-dark-blue-gradient d-flex align-items-center h-100 text-white" >
        	<h3>Overdue Articles(Past 72 Hours) &nbsp;:&nbsp; ${totalarticleavailablepastdate.size()}
            <span class="d-block text-capitalize text-small"><a href="#" class="text-white" onclick="showAndHide('overdue72')">More info <i class="fa fa-long-arrow-right"></i></a></span>
            </h3>
            <div class="icon ml-auto">
            	<svg version="1.1" id="Layer_2_copy_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
	 y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve" class="main-icon" width="100%" height="100%">
...
<g transform="translate(0,-288.53332)">
	...
	<path d="M76.7,426.6c4.3,2.4,5.7,7.8,3.3,12.1c-2.4,4.3-7.8,5.7-12.1,3.3c0,0,0,0,0,0c-4.3-2.4-5.7-7.8-3.3-12.1
       ...
       <!-- ./col -->
	                ...
	                <div class="col-md-12">
	                <c:if test="${totalarticleavailable.size() ge 1}">
	                <div class="main_tittle d-flex align-items-center"><span class="mr-2">Total Running Articles</span></div>
						<div class="content_box">
									<div class="box-body">
										<table class="table table-striped table-bordered m-0 filter7"
											...
											<tbody>
												<c:forEach var="temp" items="${totalarticleavailable}"
													varStatus="counter">
													<tr>
														<td>${counter.count}</td>
														...
														<%-- <td>${temp.articleDetail.publisher.publisherName}</td> --%>
	                ...
	                <div class="main_tittle d-flex align-items-center"><span class="mr-2">Overdue Article(Past 24 Hours)</span></div>
						<div class="content_box">
									<div class="box-body">
										<table class="table table-striped table-bordered m-0 filter7"
											id="overdue">
	                ...
	                <div class="main_tittle d-flex align-items-center"><span class="mr-2">Overdue Article(Past 48 Hours)</span></div>
						<div class="content_box">
									<div class="box-body">
										<table class="table table-striped table-bordered m-0 filter7"
											id="overdue1">
	                ...
	                <div class="main_tittle d-flex align-items-center"><span class="mr-2">Overdue Article(Past 72 Hours)</span></div>
						<div class="content_box">
									<div class="box-body">
										<table class="table table-striped table-bordered m-0 filter7"
											id="overdue72">
     ...
     <!--main_tittle_End-->
      ...
      <div class="col mb-3"> 
        ...
        <div class="small-box text-red d-flex align-items-center h-100 box-shadow">
            <h3> Total Article &nbsp;:&nbsp; ${articlegroupby.size()}
          	</br>
      ...
      <div class="col mb-3"> 
        <!-- small box -->
        <div class="small-box text-red d-flex align-items-center h-100 box-shadow" >
         <h3>Total Article For Today  &nbsp;:&nbsp; ${articlegroupbyToday.size()}
            <span class="d-block text-capitalize text-midium text-blue"> More info <i class="fa fa-long-arrow-right"></i></span>
            </h3>
            <div class="icon ml-auto">
...
<!-- 
 ...
 Highcharts.chart('container', {
	    ...
	    series: [{
	        ...
	        data: [
	          /*   ['24 Hour', ${totalarticleavailable24}, false],
	            ['48 Hour', ${totalarticleavailable48}, false],
	            ['72 Hour', ${totalarticleavailablepast}, false] */

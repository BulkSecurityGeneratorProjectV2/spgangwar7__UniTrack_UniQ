...
<div class="main_part_outer" id="content">
    ...
    <div class="row">
       <div class="col-md-9">
           <div class="main_tittle">Journal Delivery Trend <span id="Date">Wednesday , 21 November 2018</span></div>
    ...
    padding-top: 8px;">
     ...
     <div class="row">
						...
						<div class="content_box">
							<div class="box-body">
								<div id="JournalCurrentLoadandOverdue" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
							</div>
						</div>
					</div>
				</div>
...
<script src="https://code.highcharts.com/modules/drilldown.js"></script>
    ...
    Highcharts.chart('JournalCurrentLoadandOverdue', {
        chart: {
            type: 'column'
        },
        title: {
            text: 'A&A Journal - Current Load and Overdue - WK39'
        },

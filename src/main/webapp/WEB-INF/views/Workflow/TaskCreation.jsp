							...
							<div class="content_box">
								<div class="box-body">
									...
									<div class="tabContainer">
										<div class="tabs">
											<ul>
												<li class="active"><strong>Task Creation</strong></li>
												<li>Define Rules</li>
												<li>Preview</li>
									...
									<div class=" mt-20">
										<div class="">
											...
											<div class=" mt10">
												...
												<div class="tab-pad border bg-white">

													<div id='Show-wf'>
														<div class="form-group row">
															<c:if test="${workflowName eq null}">
																<label for="staticEmail" class="col-sm-1 col-form-label">Create
																	New<sup class="text-red">&lowast;</sup>
																</label>

															</c:if>
															<c:if test="${workflowName ne null ||''}">
																<label for="staticEmail" class=" col-form-label">Workflow
																	Name </label>

															</c:if>
															<div class="col-sm-4">
																<c:if test="${workflowName eq null}">
																	<input type="text" maxlength=40 id="WorkflowNameId"
																		class="form-control" placeholder="Workflow name"
																		autocomplete=flase name="name" value="${workflowName}">
																</c:if>
																
																<c:if test="${workflowName ne null ||''}">
																	<input type="text" maxlength=40 id="WorkflowNameId"
																		readonly class="form-control"
																		placeholder="Workflow name" name="name"
																		value="${workflowName}">
																</c:if>

															</div>
															<label for="staticEmail" class=" col-form-label"
																style="font-size: 13px;" style="font-size:13px;">Workflow
																Type <sup class="text-red">&lowast;</sup>
															</label>

															<div class="col-sm-2">
																<c:if test="${workFlowType eq 'Article'}">
																	<input type="text" id="workflowType"
																		readonly class="form-control" value="${workFlowType}">
																</c:if>
																<c:if test="${workFlowType eq 'Issue'}">
																	<input type="text" id="workflowType"
																		readonly class="form-control" value="${workFlowType}">
																</c:if>
																<c:if test="${workFlowType eq null}">
												...
												<div class="row mt-3">
													<div class="col-md-12 col-sm-12 col-xs-12">
														<p class="">
															...
															<input class="form-control" type="hidden"
																name="workflowid" id="workflowid" value="${workflowid}">
													...
													<div class="col-sm-12">
														<div class="task-panel border">
															<div class="col-sm-6 ">
																<div class="task-font">Available Tasks</div>

																<div class="task-height min-h-480">
																	...
																	<ol
																		...
																		<c:forEach var="temp" items="${taskDetails}"
																			varStatus="counter">
																			<li
																				class="draggable-item ui-sortable-handle back-bgs"><a
															...
															<div class="col-sm-6">
																<div class="task-font">
																	Selected Task<sup class="text-red">&lowast;</sup><small
																		id="preErr"></small>
																</div>
																<div class="task-height min-h-480">
																	<ol
																		...
																		<c:forEach var="temp" items="${workflowTaskSeqlist}"
																			...
																			<li class="draggable-item ui-sortable-handle"><a
																				href="#">${temp.task.taskName}<span class="hide">${temp.task.id}</span></a></li>
																		</c:forEach>
																	</ol>
																</div>
															</div>
...
function createNewTask() {
	...
	function validate() {
		...
		if(workflowType == 'Select Workflow Type' ||''){
			//$("#wtermsg").empty();
...
<script>
$('#WorkflowNameId').on('input', function() {

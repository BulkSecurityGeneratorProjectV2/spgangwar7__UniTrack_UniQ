												...
												<div
													...
													<div class=row>
														...
														<div class="col-xs-4 col-sm-4 col-lg-4">
															...
															</span> --%><!-- Ravi changed this  -->
															<span class="font-head">Current Task Name :
															 <c:if test="${taskRealName ne null}">
															 <mark
																	style="color: white; background-color: green;">${taskRealName}</mark>
															 </c:if>
															 <c:if test="${taskRealName eq ''}">
															 <mark
																	style="color: white;">${taskRealName}</mark>
															 </c:if>
															</span>
														</div>
														<div class="col-xs-4 col-sm-4 col-lg-4">
																...
																<div class="border-2 tab-pad col-sm-12 ">
																	<div>
																		<div class="row">
																			...
																			<div class="col-sm-6">
																				<div class="form-group">
																					<label for="tat">Function <sup class="text-red">&lowast;</sup>
																					<%--  <c:if test="${roleName ne null}">
																					...
																					<form:select path="rolelist" id="RoleId"
																						...
																						<c:if test="${workflowTaskSeq.role.roleName eq ''}">
                                                                                           <form:option value = "" labelValue = "${workflowTaskSeq.role.roleName}"/>
                                                                                       </c:if>
																						<c:if test="${roleName eq null}">
																			...
																			<div class="col-sm-6">
																				<div class="form-group">
																					<label for="tat">Input Folder:</label> <input
																						type="text" class="form-control" id="tat" name=""
																			...
																			<div class="col-sm-6">
																				<div class="form-group">
																					<label for="tat">Output Folder:</label> <input
																						type="text" class="form-control" id="rr" name=""
																						value="">
																				</div>
																			</div>
																			<div class="col-sm-6">
																				<div class="form-group">
																					<label for="tat">File Type:</label> 
																				<select id="fileType" name="fileType" class="form-control">
																					
																						<option value="all" ${workflowTaskSeq.fileType == 'null' ? "selected" : ""}>ALL</option>
																						<option value="pdf" ${workflowTaskSeq.fileType == 'pdf' ? "selected" : ""}>PDF</option>
																						<option value="docx" ${workflowTaskSeq.fileType == 'docx' ? "selected" : ""}>Word File</option>
																						<option value="xml" ${workflowTaskSeq.fileType == 'xml' ? "selected" : ""}>XML</option>
																						<option value="zip" ${workflowTaskSeq.fileType == 'zip' ? "selected" : ""}>ZIP</option>
																						<option value="docx or pdf" ${workflowTaskSeq.fileType == 'docx,.pdf' ? "selected" : ""}>Word File And PDF</option>
				                  ...
				                  <form:options items = "${taskDetails}" itemValue="id" itemLabel="taskName" />
																			...
																			<div class="col-sm-3">
																				<div class="form-group">
																					...
																					<div>
																						<label for="email">Email  <sup class="text-red">&lowast;</sup></label>
																					</div>
																					<label class="radio-inline  mr-3"> <input checked
																						id="yes" type="radio" name="emailFlag" value="YES"
																			...
																			<div class="col-sm-3">
																				<div class="form-group">
																					<div>
																						<label for="readOnly">File Access
																							 <!-- <sup class="text-red">&lowast;</sup> --></label>
																					</div>
																					<label class="radio-inline  mr-3"> <input checked
																						type="radio" name="readOnly" value="YES"
																			...
																			<div class="col-sm-3">
																				<div class="form-group">
																					<div>
																						<label for="assign_back">Assign Back 
																							<!-- <sup class="text-red">&lowast;</sup> --></label>
																					</div>
																					<label class="radio-inline  mr-3"> <input checked
																						...
																						type="radio" name="assign_back" value="NO"
																			...
																			<div class="col-sm-3">
																				<div class="form-group">
																					<div>
																						<label for="email">Approval<!--  <sup class="text-red">&lowast;</sup> --></label>
																					</div>
																					<label class="radio-inline  mr-3"> <input checked
																						type="radio" name="approval" value="YES"
																			...
																			<div class="col-sm-3">
																				<div class="form-group">
																					<div>
																						<label for="email">Skip <!-- <sup class="text-red">&lowast;</sup> --></label>
																					</div>
																					<label class="radio-inline  mr-3"> <input
																						type="radio" name="skip" value="YES" checked

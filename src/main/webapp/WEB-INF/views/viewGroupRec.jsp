...
<body class="d-flex flex-column top-panel">
<div class="h-100 text-center d-flex w-100 top-panel">
	<div class="align-self-center w-100"><img src="resources/images/uni-logo.png"  class="border p-1 shadow rounded">
		...
		<a href="${context}/cregrouptask" class="myButton mt-4">Click Here</a>
	</div>
</div>

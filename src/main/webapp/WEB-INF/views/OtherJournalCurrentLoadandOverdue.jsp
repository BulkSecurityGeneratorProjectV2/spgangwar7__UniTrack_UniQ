...
<div class="main_part_outer" id="content">
    ...
    <div class="row">
       <div class="col-md-9">
           <div class="main_tittle">Other Journals Delivery Trend <span id="Date">Wednesday , 21 November 2018</span></div>
    ...
    padding-top: 8px;">
     ...
     <div class="row">
						...
						<div class="content_box">
							<div class="box-body">
								<div id="OtherJournalCurrentLoadandOverdue" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
							</div>
						</div>
					</div>
				</div>
...
<script src="https://code.highcharts.com/modules/drilldown.js"></script>
    ...
    Highcharts.chart('OtherJournalCurrentLoadandOverdue', {
        chart: {
            type: 'column'
        },
        title: {
            text: 'Other Journal (including French) - Current Load and Overdue -WK39'
        },

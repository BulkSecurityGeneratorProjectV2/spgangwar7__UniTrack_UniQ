    ...
    padding-top: 8px;">
     ...
     <div class="row">
						...
						<div class="content_box">
							<div class="box-body">
								<div id="OtherJournalDeliveryTrend" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
							</div>
						</div>
					</div>
				</div>
...
<script src="https://code.highcharts.com/modules/drilldown.js"></script>
    ...
    Highcharts.chart('OtherJournalDeliveryTrend', {
        chart: {
            type: 'column'
        },
        title: {
            text: 'Other Journals (including French) - Delivery Trend - WK39'
        },

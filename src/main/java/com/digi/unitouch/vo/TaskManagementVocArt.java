...
public class TaskManagementVocArt
{
	...
	public TaskManagementVocArt(Integer article_id, Integer journalId, String publ_name, String task_name,
	...
	public String toString() {
		return "TaskManagementVocArt [article_id=" + article_id + ", journalId=" + journalId + ", publ_name="
				+ publ_name + ", task_name=" + task_name + ", task_status=" + task_status + ", suplliername="
				+ suplliername + ", article_title=" + article_title + ", sch_start_time=" + sch_start_time
				+ ", sch_end_time=" + sch_end_time + ", journal_name=" + journal_name + ", article_doi=" + article_doi
				+ ", article_type_cd=" + article_type_cd + ", first_name=" + first_name + ", last_name=" + last_name

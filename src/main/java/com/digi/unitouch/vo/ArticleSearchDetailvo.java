...
public class ArticleSearchDetailvo {
...
//	}
	...
	public ArticleSearchDetailvo(Integer article_id, String aid, String article_title, String task_status,
	...
	public String toString() {
		return "ArticleSearchDetailvo [article_id=" + article_id + ", aid=" + aid + ", article_title=" + article_title
				+ ", task_status=" + task_status + ", sch_start_time=" + sch_start_time + ", sch_end_time="
				+ sch_end_time + ", start_date_time=" + start_date_time + ", completed_date_time=" + completed_date_time
